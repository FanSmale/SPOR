...
public class SimpleTool {
     ...
     *  
     * @return  dateString The current time.
     */  
	...
	/**
	 ************************************** 
	 * Sort the given array and return the index.
	 * 
	 * @param paraArray : the given array.
	 * @return resultIndex : the index of sorted array.
	 ************************************** 
	 */
	public static int[] argsort(double[] paraArray) {
		double[] tempArray = new double[paraArray.length];
		for (int i = 0; i < tempArray.length; i++) {
			tempArray[i] = paraArray[i];
		}
		HashMap map = new HashMap();
		int[] resultIndex = new int[tempArray.length];
		for (int i = 0; i < tempArray.length; i++) {
		...
		int[] tempIndex = new int[resultIndex.length];
		for (int i = 0; i < resultIndex.length; i++) {
			tempIndex[i] = (int) map.get(tempArray[i]);
		}

		/**
		 * for (int i = 0; i < tempIndex.length; i++) { resultIndex[i] = tempIndex[tempIndex.length - i -
		 * 1]; }
		 */
		return tempIndex;
	}
	...
	/**
	 ************************************** 
	 * Perform min-max normalization. Normalize to [0, 1]. The data table is changed directly.
	 * 
	 ...
	 * @param paraSecond    the second instance
	 * @param invConvMatrix The ConvMatrix used in Mahalanobis distance
	 * @return the Mahalanobis distance between the two given instances, between 0 and 1
	 ********************
	 */
	 ...
	 * @param metricOrder   Possible instance weighting methods
	 * @param invConvMatrix The ConvMatrix used in Mahalanobis distance
	 * @return the Euclidean distance between the two given instances, between 0 and 1
	 ********************
	 */
